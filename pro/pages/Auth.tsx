        ...
        <div className="relative h-full w-full bg-[url('/images/hero.jpg')] bg-no-repeat bg-fixed bg-cover">
            <div className="bg-black w-full h-full lg:bg-opacity-50">
                <nav className="px-12 py-5">
                    <img src="/images/logo.png" alt="log" className="h-12"  />
                </nav>
                <div>
                    <div className="flex justify-center">
                        <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
                            ...
                            <div className='flex items-center justify-center gap-4 mt-8'>
                                <div className='bg-white rounded-full flex items-center justify-center h-10 w-10 m-4 cursor-pointer hover:opacity-80 transition'>
                                    <FcGoogle size={32} />
                                </div>
                                <div onClick={() => signIn('github', { callbackUrl: '/' })} className='bg-white rounded-full flex items-center justify-center h-10 w-10 m-4 cursor-pointer hover:opacity-80 transition'>
                                    <FaGithub size={32} />
                                </div>
